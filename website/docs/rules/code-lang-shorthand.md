...
You can find the full list of [language identifiers shorthand mapping](https://github.com/eslint-markdown/eslint-markdown/blob/main/packages/eslint-markdown/src/rules/code-lang-shorthand.ts) in the source code.
