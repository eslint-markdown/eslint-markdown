...
| [`MD005` - Inconsistent indentation for list items at the same level](https://github.com/DavidAnson/markdownlint/blob/main/doc/md005.md#md005---inconsistent-indentation-for-list-items-at-the-same-level) :white_check_mark: | [`md/consistent-list-indentation`](../rules/consistent-list-indentation.md) |
