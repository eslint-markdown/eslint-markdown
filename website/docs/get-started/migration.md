...
| [`MD039` - Spaces inside link text](https://github.com/DavidAnson/markdownlint/blob/main/doc/md039.md#md039---spaces-inside-link-text) :warning: | [`md/no-space-in-link-text`](../rules/no-space-in-link-text.md) |
